...
//voert de query uit
$stmt->execute();
//haal alle bestemmingen uit de database met hun info, haal daarbij ook de gemiddelde score van reviews op
$result = $stmt->fetchAll(PDO::FETCH_ASSOC);
$Bestemmingresult = $result;

//voor elke individuele bestemming die opgehaalt is
...
<body>
  <div class="container col-xl-10 col-xxl-8 px-4 py-5 mb-5">
    ...
    <?php
    //haal individuele bestemmingen uit de array Bestemmingen, je hebt nu een bestemming
      foreach ($Bestemmingen as $bestemming) {
        //laat bestemming zien in html-bootstrap card
        $bestemming->ShowBestemming(290);
      }
    ?>
  </div>
</body>
