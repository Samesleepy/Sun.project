    ...
    <div class="card bg-light">
        <div class="card-body mx-auto" style="width: 800px;">
            ...
            <form action="" method="post">
                ...
                <div class="my-3">
                    <div class="text-end ">
                        <button type="button" class="btn btn-danger" style="float: left;" data-bs-toggle="modal" data-bs-target="#exampleModal">Account verwijderen</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body" style="text-align:center;">
                    Weet je zeker dat je je account wilt verwijderen? Je kunt je account niet meer terug krijgen zodra je het verwijderd.
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Sluiten</button>
                    <button id="test" type="submit" name="delete" class="btn btn-danger btn-block ">Verwijder account</button>
                </div>
            </div>
        </div>
    </div>
